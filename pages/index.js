      ...
      <div id="main-content">
        <nav className="site-nav fixed w-full z-50 top-0 left-0">
          <div className="nav-inner flex items-center justify-between px-6 md:px-16 py-4">
            ...
            <div className="nav-links hidden lg:flex space-x-10 uppercase text-[11px] tracking-[0.3em] font-medium items-center">
              ...
              <a href="/vault" className="text-gray-300 hover:text-white transition">The Vault</a>
        ...
        <div className={`mobile-menu ${mobileMenuOpen ? '' : 'hidden'}`} id="mobile-menu">
          <div className="mobile-menu-inner">
            ...
            <a href="/vault" className="mobile-nav-link" onClick={() => setMobileMenuOpen(false)}>The Vault</a>
        ...
        <section className="relative h-screen flex flex-col justify-center items-center text-center px-4 bg-black overflow-visible">
          ...
          <div className="relative z-20 max-w-4xl mx-auto px-4 mt-16 hero-copy">
            ...
            <div className="hero-actions">
              ...
              <a href="/vault" className="border border-white/20 text-white px-8 py-3.5 text-xs font-bold uppercase tracking-[0.2em] hover:border-gold transition-all duration-300">View Vault</a>
            </div>
          </div>
        ...
        <section className="py-28 bg-black border-y border-white/5 reveal">
          <div className="max-w-5xl mx-auto px-6 md:px-16 text-center">
            ...
            <a
              href="/vault"
              className="inline-flex border border-gold text-gold hover:bg-gold hover:text-black font-semibold uppercase text-xs tracking-[0.3em] px-10 py-4 transition duration-300"
            >
              Enter The Vault
            </a>
          </div>
